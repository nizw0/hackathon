...
export function Notice(props) {
  return (
    <div className="bg-[#182025] px-5 py-12" id={props.id}>
      ...
      <Line />
      <div>
        <h3 className="px-5 text-left text-3xl font-bold text-white">競賽主題</h3>
        <div className="mt-2 bg-[#292e42] py-4">
          <h4 className="pb-5 text-left text-2xl font-bold text-white">🌱永續發展與社會責任</h4>
          <p className="mb-4 text-left indent-6 text-lg font-normal tracking-wide text-white dark:text-gray-400 lg:tracking-normal">
          ...
          <img className="mx-auto mb-5 h-auto w-full rounded-lg md:w-4/5" src={themePicture} />
          <div className="text-left">
            <Link href="https://aws.amazon.com/tw/events/taiwan/interviews/articles-climatepledge">
              AWS王定愷：引領企業永續發展的綠色雲
            </Link>
            <p className="my-4 text-left indent-6 text-lg font-bold tracking-wide text-white dark:text-gray-400 lg:tracking-normal">
              亞馬遜 AWS 香港暨台灣總經理王定愷： 「AWS
              作為全球雲端運算的先鋒和領導者，不僅以環境友好的方式營運業務，還希望透過提供高效節能、低能耗的綠色雲端服務，幫助客戶和合作夥伴實現其永續發展目標，推動經濟社會發展向綠色低碳轉型。」
            </p>
            <p className="mb-4 text-left indent-6 text-lg font-bold tracking-wide text-white dark:text-gray-400 lg:tracking-normal">
      ...
      <div>
        <h3 className="px-5 py-5 text-left text-3xl font-bold text-white">線上說明影片（預計 12/21 釋出）</h3>
        <div className="flex justify-center">
          <div
            role="status"
            className="flex h-96 w-4/5 animate-pulse items-center justify-center rounded-lg bg-gray-300 dark:bg-gray-700"
          >
            <svg
      ...
      <div>
        <h3 className="px-5 py-5 text-left text-3xl font-bold text-white">評分方式</h3>
        <div className="mb-5">
          <h4 className="pb-5 text-left text-2xl font-bold text-white">初賽</h4>
          <ul className="list-inside list-decimal space-y-4 text-left text-lg font-bold text-white md:text-xl">
            <li>
              相關性 20%
              <ol className="mt-2 list-inside list-disc space-y-1 pl-5 font-normal">
        ...
        <div>
          <h4 className="pb-5 text-left text-2xl font-bold text-white">決賽</h4>
          <ul className="list-inside list-decimal space-y-4 text-left text-lg font-bold text-white md:text-xl">
            <li>
              內容完整性 30%
              <ol className="mt-2 list-inside list-disc space-y-1 pl-5 font-normal">
